...
{
    return ( (bitbucket << (31 - msbindex)) >> (31 - (msbindex - lsbindex)) );
}
...
int main()
{
    ...
    uint32_t y = push_lsb_bit( 13, 0 );
    printf( "push_lsb_bit( 13, 0 ) is %d\n", y );
